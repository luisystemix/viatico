...
{
    public partial class repListaPreliminar : System.Web.UI.Page
    {
        ...
        protected void Reporte_LISTA_PROD()
        {
            ...
            GVListOfi.DataSource = ListRep.DB_Reporte_PLANILLA_PROD(Convert.ToInt32(LblIdInsOrg.Text), "LISTAPRELIMINAR");
            GVListOfi.DataBind();
        }
        #endregion
