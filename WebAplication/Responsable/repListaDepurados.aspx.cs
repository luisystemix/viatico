...
{
    public partial class repListaDepurados : System.Web.UI.Page
    {
        ...
        protected void Reporte_LISTA_PROD()
        {
            ...
            GVListOfi.DataSource = ListRep.DB_Reporte_PLANILLA_PROD(Convert.ToInt32(LblIdInsOrg.Text), "LISTA_DEPURADOS");
            GVListOfi.DataBind();
        }
        #endregion
