<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="repListaOficial.aspx.cs" Inherits="WebAplication.Responsable.repListaOficial" %>
    ...
    <div>
        ...
        <table class="TableBorder">
            <tr>
                ...
                <td width="200" class="auto-style3"><div style="text-align: center">E-EMP/GP/ P /301 R04</div></td>
            </tr>
            <tr>
                <td><div style="text-align: center">REGISTRO</div>
                <td><div style="text-align: center">Versión N°1</div></td>
            </tr>
            <tr>
                <td><div style="text-align: center">LISTA OFICIAL DE BENEFICIARIOS</div>
                <td>&nbsp;</td>
            </tr>
        </table>
