<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmListaDistribSemilla.aspx.cs" Inherits="WebAplication.Extensiones.frmListaDistribSemilla" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GVDistribSem" runat="server" CssClass="TableBorder" AutoGenerateColumns="False">
        <Columns>
