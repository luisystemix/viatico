<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmParcelaSiembra.aspx.cs" Inherits="WebAplication.Extensiones.frmParcelaSiembra" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#miCampo1').validarcampo(' abcdefghijklmnñopqrstuvwxyzáéiou');

            //Para escribir solo numeros    
            $('#TxtNumBoleta').validarcampo('0123456789');
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="SubTitulo2">DATOS DEL SEGUIMIENTO TÉCNICO REALIZADO</div><table class="TableBorder">
        ...
        <tr>
            <%--<td>&nbsp;</td>
            <td><div style="text-align: right">Hora:</div></td>
            <td>
    ...
    <asp:Panel ID="PnlDatsParcela" runat="server" Visible="False">
        ...
        <table class="TableBorder">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DDLVariedad" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDLVariedad_SelectedIndexChanged">
                    </asp:DropDownList>
