...
{
    public partial class frmRP_SegFenologias : System.Web.UI.Page
    {
        ...
        private void Desplegar_GRILLA_ENVIADOS()
        {
            ...
            GVEnviadosSemana.DataSource = fendetalle.DB_Seleccionar_ENVIOS_SEMANA(Convert.ToInt32(DDLRegional.SelectedValue));
