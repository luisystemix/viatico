...
{
    public partial class frmDetallePagos : System.Web.UI.Page
    {
        ...
        protected void BtnCalcular_Click(object sender, EventArgs e)
        {
            ...
            if (TxtFechIni.Text != "") {
                if (EsFecha(TxtFechIni.Text)) {
                    Desplegrar_GRILLA();
                }
                else
                    lblMensaje.Text = "Fecha NO Valida...";
            }
            else
                lblMensaje.Text = "Ingresar Fecha...";
        ...
        protected void ImgPrint_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Label1.Text = "<br/><br/><table align='center' width='800px'><tr align='center'><td><img src='http://201.222.80.212/emapaglobal/img/bannerReport.jpg'alt='EMAPA-Documento' style='float:inherit'/></td><td></td><td></td><td colspan='5'><b style='text-align: center'>EMPRESA DE APOYO A LA PRODUCCION DE ALIMENTOS<br />REPORTE DETALLE DE VIAJES REALIZADOS</b><br> A PARTIR DEL "+ TxtFechIni.Text +"<br /></td><td></td><td></td><td></td></tr><tr align='center'><td colspan='11'><b></b> </td></tr></table>";
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=ReporteDetallePagos.xls");
        ...
        protected void GVListaViajes_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                DateTime fSalida = Convert.ToDateTime(DataBinder.Eval(e.Row.DataItem, "FECHA_SALIDA"));
                DateTime fRetorno = Convert.ToDateTime(DataBinder.Eval(e.Row.DataItem, "FECHA_RETORNO"));
                TimeSpan dias = fRetorno.Subtract(fSalida);
                int d = dias.Days;
                int finesSemana = (d/7)*2;
                if (finesSemana > 0)
                {
                    ((Label)e.Row.FindControl("LblFechRetorno")).Text = (d - finesSemana).ToString();
                }
                else {
                    ((Label)e.Row.FindControl("LblFechRetorno")).Text = (d - finesSemana+1).ToString();
                }
