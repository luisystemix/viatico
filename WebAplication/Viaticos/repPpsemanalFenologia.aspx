<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="repPpsemanalFenologia.aspx.cs" Inherits="WebAplication.Viaticos.repPpsemanalFenologia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="TableBorder">        
        <tr>
            ...
            <td>
                <asp:Label ID="Label1" runat="server" Text="Usuario | Regional | Programa | Precipitacón | FechaReg(Ini) | FechaReg(Fin)"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlSemanas" runat="server" Width="250px" OnSelectedIndexChanged="ddlSemanas_SelectedIndexChanged1" Font-Size="X-Small">
                </asp:DropDownList>
            </td>
            <td align="right">
